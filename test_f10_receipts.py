...
def run_adversarial():
    ...
    c1 = GossipClient("c1")
    c1.collect("chain-R", cpA["checkpoint"]["event_id"], roster)
    r1 = c1.conflict_report("chain-R", cpA["checkpoint"]["event_id"], pubs)
    ...
    c2 = GossipClient("c2")
    c2.collect("chain-R", cpA["checkpoint"]["event_id"], roster)
    r2 = c2.conflict_report("chain-R", cpA["checkpoint"]["event_id"], pubs)
    ...
    r3 = merged.conflict_report("chain-R", cpA["checkpoint"]["event_id"], pubs)
